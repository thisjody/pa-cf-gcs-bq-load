...
declare -a required_vars=("GEN2" "RUNTIME" "REGION" "SERVICE_ACCOUNT" "CLOUDFUNCTION" "SOURCE" "ENTRY_POINT" "TRIGGER_TOPIC" "PUBLISH_TOPIC" "MEMORY" "TIMEOUT" "PROJECT_ID" "PUBLISH_SA" "LOAD_SA" "TARGET_SCOPES" "SA_CREDENTIALS_SECRET_NAME")
unset_vars=()
...
SET_ENV_VARS="PROJECT_ID=$PROJECT_ID,PUBLISH_SA=$PUBLISH_SA,LOAD_SA=$LOAD_SA,TARGET_SCOPES=$TARGET_SCOPES,SA_CREDENTIALS_SECRET_NAME=$SA_CREDENTIALS_SECRET_NAME,PUBLISH_TOPIC=$PUBLISH_TOPIC"
