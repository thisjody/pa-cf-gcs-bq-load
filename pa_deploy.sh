...
declare -a required_vars=("GEN2" "RUNTIME" "REGION" "SERVICE_ACCOUNT" "CLOUDFUNCTION" "SOURCE" "ENTRY_POINT" "TRIGGER_TOPIC" "MEMORY" "TIMEOUT" "PROJECT_ID" "IMPERSONATE_SA_MAP" "TARGET_SCOPES" "SA_CREDENTIALS_SECRET_NAME")
unset_vars=()
